# Did You Mean API - Examples

This folder contains example code for using the Did You Mean API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/didyoumean',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/didyoumean");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/didyoumean](https://docs.apiverve.com/ref/didyoumean)
